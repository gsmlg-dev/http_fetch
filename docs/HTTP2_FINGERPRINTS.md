...
`HTTP.HTTP2.Fingerprint.observe/2` accepts serialized client bytes, bounds frame
parsing, records ordered SETTINGS/window/header/frame summaries, and redacts
